...
class Ui_ErrorWindow(object):
    def setupUi(self, ErrorWindow):
        ...
        ErrorWindow.resize(500, 250)
        ErrorWindow.setMinimumSize(QSize(500, 250))
        ErrorWindow.setMaximumSize(QSize(500, 250))
        ErrorWindow.setBaseSize(QSize(500, 250))
        palette = QPalette()
        ...
        ErrorWindow.setPalette(palette)
        ErrorWindow.setStyleSheet(u"/* \u041e\u0441\u043d\u043e\u0432\u043d\u044b\u0435 \u0446\u0432\u0435\u0442\u0430 */\n"
"QWidget {\n"
...
"    color: rgb(16, 16, 15"
                        "); /* WindowText */\n"
"}")
        self.horizontalLayout_2 = QHBoxLayout(ErrorWindow)
        ...
        self.label_2 = QLabel(ErrorWindow)
        ...
        self.label_3 = QLabel(ErrorWindow)
        ...
        self.button_error_ok = QPushButton(ErrorWindow)
...
"font-size: 16pt;")
    ...
    def retranslateUi(self, ErrorWindow):
        ErrorWindow.setWindowTitle(QCoreApplication.translate("ErrorWindow", u"\u041e\u0448\u0438\u0431\u043a\u0430 \u0432\u0432\u043e\u0434\u0430", None))
        self.label_2.setText("")
        self.label_3.setText(QCoreApplication.translate("ErrorWindow", u"\u041e\u0448\u0438\u0431\u043a\u0430", None))
        self.label.setText(QCoreApplication.translate("ErrorWindow", u"<html><head/><body><p>\u0423\u0431\u0435\u0434\u0438\u0442\u0435\u0441\u044c, \u0447\u0442\u043e \u0432\u0441\u0435 \u043f\u043e\u043b\u044f \u0437\u0430\u043f\u043e\u043b\u043d\u0435\u043d\u044b \u043a\u043e\u0440\u0440\u0435\u043a\u0442\u043d\u043e (\u0432\u0432\u0435\u0434\u0435\u043d\u044b \u0442\u043e\u043b\u044c\u043a\u043e \u0446\u0438\u0444\u0440\u044b \u0438 \u0446\u0438\u0444\u0440\u044b \u0447\u0435\u0440\u0435\u0437 \u0437\u0430\u043f\u044f\u0442\u0443\u044e \u0438\u043b\u0438 \u0442\u043e\u0447\u043a\u0443).</p></body></html>", None))
        self.button_error_ok.setText(QCoreApplication.translate("ErrorWindow", u"\u041e\u041a", None))
    # retranslateUi
